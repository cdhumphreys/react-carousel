...
/******/ 	var hotCurrentHash = "19e3b336f9ca24559dfe"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Carousel = __webpack_require__(166);
	...
	var images = ['http://i.istockimg.com/file_thumbview_approve/68125355/6/stock-photo-68125355-abstract-hexagon-pattern-background.jpg', 'http://i.istockimg.com/file_thumbview_approve/84374361/6/stock-illustration-84374361-watercolor-background.jpg', 'http://i.istockimg.com/file_thumbview_approve/61052940/6/stock-illustration-61052940-technology-background.jpg', 'http://i.istockimg.com/file_thumbview_approve/65600133/6/stock-illustration-65600133-abstract-background.jpg', 'http://i.istockimg.com/file_thumbview_approve/79975655/6/stock-illustration-79975655-festive-christmas-bokeh-background.jpg', 'http://i.istockimg.com/file_thumbview_approve/61490150/6/stock-photo-61490150-multicolor-abstract-geometric-rumpled-triangular-low-poly-style-illustration.jpg', 'http://i.istockimg.com/file_thumbview_approve/77938125/6/stock-illustration-77938125-vector-glowing-stars-ghts-and-sparkles.jpg'];
	...
	var Layout = function (_React$Component) {
		...
		_createClass(Layout, [{
			...
			value: function render() {
				return _react2.default.createElement(_Carousel2.default, { images: images });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CarouselImage = __webpack_require__(167);
	
	var _CarouselImage2 = _interopRequireDefault(_CarouselImage);
	
	var _stylesheet = __webpack_require__(168);
	...
	var Carousel = function (_React$Component) {
		...
		_createClass(Carousel, [{
			...
			value: function render() {
				...
				return _react2.default.createElement('div', { style: styles.container }, _react2.default.createElement('div', { style: styles.leftArrow, className: 'bounceLeft', onClick: this.prevImage.bind(this) }), _react2.default.createElement('ul', null, this.props.images.map(function (image, index) {
					return _react2.default.createElement('li', { style: styles.listStyles, key: index }, _react2.default.createElement(_CarouselImage2.default, { imageIndex: index, active: _this2.state.activeIndex == index ? 'active' : '', imageSrc: image }));
				})), _react2.default.createElement('div', { style: styles.rightArrow, className: 'bounceRight', onClick: this.nextImage.bind(this) }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function CarouselImage(props) {
		...
		return _react2.default.createElement('img', { src: props.imageSrc, style: props.active === 'active' ? styles.activeImage : styles.inactiveImage });
	}
